      ...
      <div className={styles.boxes}>
        ...
        >
          <Card.Body className={styles.part1}>
            <Card.Title className={styles.cardTitle1}>個人網頁舊版</Card.Title>
            <Card.Text>
          ...
          <Card.Body className={styles.part3}>
            <Card.Link
              href="https://github.com/LTN917/personalWeb-old-Version"
              className={styles.cardBtn}
            >
              Github
            </Card.Link>
            <Card.Link
              href="https://clever-biscuit-03d916.netlify.app/"
              className={styles.cardBtn}
            >
              Visit
            </Card.Link>
        ...
        >
          <Card.Body className={styles.part1}>
            <Card.Title className={styles.cardTitle1}>個人網頁新版</Card.Title>
            <Card.Text>
        ...
        >
          <Card.Body className={styles.part1}>
            <Card.Title className={styles.cardTitle1}>日本旅遊網</Card.Title>
            <Card.Text>
          ...
          <Card.Body className={styles.part3}>
            <Card.Link
              href="https://github.com/LTN917/Project-fullstack2"
              className={styles.cardBtn}
            >
              Github
            </Card.Link>
            <Card.Link
              href="https://visionary-sorbet-7f52b7.netlify.app/"
              className={styles.cardBtn}
            >
              Visit
            </Card.Link>
